...
win = Tk()
win.title("facebook Log-in")
win.geometry("400x300")
win.option_add("*Font","굴림 15")


lab1 = Label(win)
lab1.config(text = " 페이스북 ID")
lab1.pack()

ent1 = Entry(win)
ent1.insert(0,"")
def clear(event):
    if ent1.get() == "haaan0117@naver.com":
...
def login ():
    ...
    driver = webdriver.Chrome("C:/Users/qjawn/Downloads/chromedriver_win32/chromedriver.exe")
    driver.get(url)
